...
from models.modeling_res_early_exit import VisionTransformer, CONFIGS
...
def main():
    ...
    parser.add_argument("--dataset", choices=["CUB_200_2011", "car", "dog", "nabirds", "INat2017", "soyloc", "cotton", "air"], default="nabirds",
                        help="Which dataset.")
